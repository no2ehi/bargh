            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url(./assets/images/background/user-info.jpg) no-repeat;">
                    ...
                    <div class="profile-text">
                        <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">آرمان آرمانی</a>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="" aria-expanded="true">
                                ...
                                <span class="hide-menu font-bold">انتخاب سریع</span>
                            </a>
                            <ul aria-expanded="true" class="collapse font-normal">
                                <li>                                 
                        ...
                        <li class="nav-small-cap">سرگروه 2</li>
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                                <i class="mdi mdi-book-multiple"></i>
                                <span class="hide-menu font-bold">زیر گروه</span>
                            </a>
                            <ul aria-expanded="false" class="collapse font-normal">
                                <li>
                                    <a href="layout-single-column.html">تست</a>
                                </li>
