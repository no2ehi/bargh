            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="index.html">
                        <h3 class="box-title m-b-20">ورود کاربران</h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="نام کاربری"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" type="password" required="" placeholder="رمز عبور"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12">
                                <div class="checkbox checkbox-primary pull-left p-t-0">
                                    <input id="checkbox-signup" type="checkbox">
                                    <label for="checkbox-signup"> مرا به خاطر داشته باش </label>
                                </div>
                                <a href="javascript:void(0)" id="to-recover" class="text-dark pull-right">
                                    <i class="fa fa-lock m-r-5"></i> رمزم را فراموش کرده ام</a>
                            </div>
                        </div>
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <p>حساب کاربری نداری؟
                                    <a href="register.php" class="text-info m-l-5">
                                        <b>ثبت نام</b>
                                    </a>
                                </p>
                            </div>
                    ...
                    <form class="form-horizontal" id="recoverform" action="index.html">
                        <div class="form-group ">
                            <div class="col-xs-12">
                                ...
                                <p class="text-muted pright">ایمیل خود را وارد کنید تا دستور العمل برایتان ارسال شود</p>
                            </div>
                        </div>
                        <div class="form-group ">
                            <div class="col-xs-12">
