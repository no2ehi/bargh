            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="index.html">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" type="password" required="" placeholder="تکرار رمز عبور">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12 padd-20" >
                                <div class="checkbox checkbox-success p-t-0 p-l-10">
                                    ...
                                    <label for="checkbox-signup"> من موافق
                                        <a href="#">قوانین</a>
                                        هستم
                                    </label>
                                </div>
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">ثبت نام</button>
                            </div>
                        </div>
